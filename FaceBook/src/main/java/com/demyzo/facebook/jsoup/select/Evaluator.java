package com.demyzo.facebook.jsoup.select;

import com.demyzo.facebook.jsoup.helper.Validate;
import com.demyzo.facebook.jsoup.nodes.Comment;
import com.demyzo.facebook.jsoup.nodes.Document;
import com.demyzo.facebook.jsoup.nodes.DocumentType;
import com.demyzo.facebook.jsoup.nodes.Element;
import com.demyzo.facebook.jsoup.nodes.Node;
import com.demyzo.facebook.jsoup.nodes.PseudoTextElement;
import com.demyzo.facebook.jsoup.nodes.TextNode;
import com.demyzo.facebook.jsoup.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static com.demyzo.facebook.jsoup.internal.Normalizer.lowerCase;
import static com.demyzo.facebook.jsoup.internal.Normalizer.normalize;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.demyzo.facebook.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (com.demyzo.facebook.jsoup.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    com.demyzo.facebook.jsoup.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
